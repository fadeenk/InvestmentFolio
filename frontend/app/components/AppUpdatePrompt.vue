...
<template>
  <div
    ...
    class="fixed bottom-20 left-1/2 z-50 flex -translate-x-1/2 items-center gap-3 rounded-sm border border-(--ui-border) bg-(--ui-bg) px-4 py-3 shadow-lg md:bottom-4"
  >
